<?php 
  ...
  if(isset($_POST["register"])){
    ...
    if(!$error){
    $sql = "INSERT INTO `customer` (first_name, last_name, email, password) VALUES ('$first_name', '$last_name', '$email', '$userPass')";
...
<body>
  ...
  <form class="register" action="register.php" method="post" accept-charset="utf-8">
    <input class="field" type="text" name="first_name" maxlength="55" placeholder="Enter First Name" value="<?= $first_name ?>" required>
    <input class="field" type="text" name="last_name" maxlength="55" placeholder="Enter last Name" value="<?= $last_name ?>" required>
    <input class="field" type="text" name="email" maxlength="100" placeholder="Enter Email" value="<?= $email ?>" required>
    <span><?php echo $emailError; ?></span>
    <input class="field" type="password" name="password" maxlength="25" placeholder="Enter Password" required>
    <div class="row">
    <div class="col-lg-3">
    <a href="a_register.php"><input class="btn btn-success" type="submit" name="register" value="Sign Up"></a>
  </div>
   <div class="col-lg-3">
    <div class="btn-danger"><a href="index.php"><p>Back</p></a></div>
  </div>
  </div>
  </form>
</div>
